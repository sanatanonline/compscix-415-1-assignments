...
```{r varN1, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
...
```{r varN2, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
...
```{r varN3, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
df <- data.frame(x = 1:10, y = runif(10))
...
```{r varN4, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
df %>% ggvis(~x, ~y + 0.1, y2 = ~y - 0.1) %>% layer_ribbons()
```

## Examples

```{r varN5, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
set.seed(1014)
...
```{r varN6, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
...
```{r varN7, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}
...
```{r var8, echo=TRUE, eval=TRUE, warning=FALSE}
mtcars %>% 
  ggvis(~wt, ~mpg, 
